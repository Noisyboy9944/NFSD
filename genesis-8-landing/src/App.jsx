...
// =================================================================
// 1. ICONS (Built-in, no extra install needed)
// =================================================================
...
const TimelineItem = ({ side, title, content, icon: Icon, delay }) => {
    return (
        <motion.div
            ...
            className={`flex md:justify-${side === "left" ? "end" : "start"} mb-32 relative md:ml-0 ml-12`}
        >
            ...
            <div className={`md:w-1/2 w-full ${side === "left" ? 'md:pr-16 md:text-right' : 'md:pl-16 md:text-left'} relative`}>
